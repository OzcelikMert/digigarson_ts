...
import { createPayment, getTablePayment, updatePayment, getTableTotalCheck, getTableTotalPayments, createPaidOrder, updatePaidOrder, getTablePaidOrder } from "../../service/table.service";
...
//Veresiye Ödemesi eklenir
    ...
    // @access  Private
    //pos olarak görev yaptığı branch de ödeme işlemlerini yapar.
    homeHandler:  async function (req: Request, res: Response) {
        const branchId = get(req, "user.branchId");
        const userId = get(req, "user._id")
