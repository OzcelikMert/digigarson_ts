...
interface AnalysisBillOutDocument extends mongoose.Document {
...
const AnalysisBillOutModel = mongoose.model<AnalysisBillOutDocument>("AnalysisBillOut", AnalysisBillOutSchema);

export {
    AnalysisBillOutModel,
    AnalysisBillOutDocument
};
