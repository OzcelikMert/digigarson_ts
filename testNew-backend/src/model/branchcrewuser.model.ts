...
interface BranchCrewUserDocument extends mongoose.Document {
    name: string;
    lastname: string;
    password: string;
...
const BranchCrewUserModel = mongoose.model<BranchCrewUserDocument>("branchcrewuser", BranchCrewUserSchema);
