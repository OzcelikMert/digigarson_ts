...
interface AnalysisBillInflowDocument extends mongoose.Document {
...
const AnalysisBillInflowModel = mongoose.model<AnalysisBillInflowDocument>("AnalysisBillInflow", AnalysisBillInflowSchema);

export {
    AnalysisBillInflowModel,
