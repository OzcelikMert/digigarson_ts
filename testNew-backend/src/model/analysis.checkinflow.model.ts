...
interface AnalysisCheckInflowDocument extends mongoose.Document {
...
const AnalysisCheckInflowModel = mongoose.model<AnalysisCheckInflowDocument>("AnalysisCheckInflow", AnalysisCheckInflowSchema);

export {
    AnalysisCheckInflowModel,
    AnalysisCheckInflowDocument
};
