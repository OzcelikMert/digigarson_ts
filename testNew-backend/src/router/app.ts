...
app.route('/orders/:branchId/:tableId')
    // create new Order
    .post([validateRequest(OrderSchema.create), requiresUser, checkTable, checkProducts], createOrderHandler)
    // adding product in Order
    .put([validateRequest(OrderSchema.update), requiresUser, checkTable, checkProducts], addProductOrderHandler)
