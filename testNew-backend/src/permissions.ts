export default {
  ...
  'DELETE|/v1/pos/couriers/:courierId': 500, // update Courier  @PRIVATE
  'GET|/v1/pos/products/:productId': 500, // get Category by Id  @PRIVATE
  'GET|/v1/pos/products': 500, // get get Products  @PRIVATE
  ...
  'GET|/v1/pos/cases/close': 500, // close Case  @PRIVATE
  ...
  'POST|/v1/pos/order/move/:tableId/:MtableId': 506, //Move Products @PRIVATE
