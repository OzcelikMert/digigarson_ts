...
export interface AnalysisMoneyOutDocument extends mongoose.Document {
...
const AnalysisMoneyOut = mongoose.model<AnalysisMoneyOutDocument>("AnalysisMoneyOut", AnalysisMoneyOutSchema);

export default AnalysisMoneyOut;
