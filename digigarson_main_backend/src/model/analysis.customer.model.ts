...
export interface AnalysisCustomerDocument extends mongoose.Document {
...
const AnalysisCustomer = mongoose.model<AnalysisCustomerDocument>("AnalysisCustomer", AnalysisCustomerSchema);
